...
class BinarySearchTest {
    ...
    @Test
    void searchTest() {
        SearchStrategy<Integer> strategy = new BinarySearch<>();
        ...
        assertEquals(0,  strategy.search(new Integer[]{ 1, null, null, null, null, null, null }, 1));
        assertEquals(-1,  strategy.search(new Integer[]{ null, null, null, null, 1 }, 1));
    }
}